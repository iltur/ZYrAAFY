...
import { ADDS_CART_DTO } from '../../../application/ports/secondary/dto/adds-cart.dto-port';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: ADDS_CART_DTO, useExisting: FirebaseProductService },
    { provide: GETS_ALL_CART_DTO, useExisting: FirebaseProductService },
  ],
  exports: [],
})
