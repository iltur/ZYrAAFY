...
@NgModule({
  ...
  declarations: [],
  providers: [FirebaseProductService, { provide: GETS_ALL_PRODUCT_DTO, useExisting: FirebaseProductService }, { provide: GETS_ONE_PRODUCT_DTO, useExisting: FirebaseProductService }],
  exports: [],
})
